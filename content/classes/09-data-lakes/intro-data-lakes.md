...
!!! quote "Motivação para o surgimento do **Data Lake**!"
...
1. **Escalabilidade horizontal**: usando armazenamento de objetos (ex.: S3) com custo baixo, ou seja, foco em armazenar grandes volumes de dados de forma econômica.
1. **Neutralidade de computação**: tem capacidade de processar e analisar dados usando diferentes *engines* de computação e ferramentas analíticas, sem ficar restrito a uma única tecnologia.
1. **Retenção histórica**: buscar manter versões com histórico dos dados brutos pelo tempo definido em política de retenção, que considera requisitos legais, valor analítico e custo de armazenamento.
