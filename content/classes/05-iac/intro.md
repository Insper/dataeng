...
!!! info "Na prática..."
    É comum usar ferramentas de ambas as categorias em conjunto. Por exemplo, usar **Terraform** para provisionar a infraestrutura base e **Ansible** para configurar os aplicativos nos servidores criados.

### Abordagens: Declarativa vs Imperativa

É possível também classificar as ferramentas de **IaC** com base na abordagem que elas adotam para definir a infraestrutura:
