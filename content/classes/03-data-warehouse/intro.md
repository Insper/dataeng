...
Nas aulas anteriores, exploramos o ciclo de vida de engenharia de dados (**ingestão**, **transformação** e **disponibilização**) e a criação de *softwares* desacoplados que interagem entre si.

Na aula de hoje, vamos explorar:
