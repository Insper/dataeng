...
Nas [páginas anteriores](intro-orchestration.md), exploramos o conceito de **orquestração de dados** e identificamos as limitações do **cron** para *pipelines* complexos. Agora, iremos experimentar uma ferramenta moderna de orquestração.
...
Vamos agora criar um exemplo que simula tarefas que demandam tempo de processamento.
...
!!! exercise "Exercício"
    ...
    def verificar_novos_dados():
        ...
        # Simula presença de dados (70% das vezes há dados novos)
        tem_dados = random.random() < 0.7
...
Nas próximas aulas, exploraremos como integrar essas ferramentas em arquiteturas de dados mais complexas.