...
!!! danger "Importante!"
    Faça esta aula preferencialmente em um ambiente Linux ou WSL.

    O **cron** é uma ferramenta nativa do *Unix* e pode apresentar dificuldades de configuração em outros sistemas operacionais.
