...
!!! example "Exemplo de *Pipeline* Orquestrado"
    ...
    1. **Validação**: Verificar qualidade dos dados extraídos
    1. **Transformação**: Agregar vendas por região e período
    1. **Carga**: Inserir dados no **data warehouse**
    1. **Notificação**: Enviar email confirmando a atualização
