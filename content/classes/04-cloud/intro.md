...
- Por outro lado, uma migração mal planejada pode levar a falhas tecnológicas e custos elevados.
...
A **computação em nuvem** inverte o modelo **on-premises**.
...
!!! important "Definição: Cloud Computing"
    ...
    Esses recursos podem ser reservados de forma rápida: VMs são criadas em poucos minutos, e o uso subsequente é cobrado em incrementos (por tempo de uso).
