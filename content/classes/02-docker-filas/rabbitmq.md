...
Ele permite que diferentes partes de uma aplicação se comuniquem de forma assíncrona pelo protocolo **AMQP**, enviando mensagens entre **produtores** e **consumidores**.
...
??? info "**AMQP**"
    O [**AMQP**](https://www.rabbitmq.com/tutorials/amqp-concepts) (**Advanced Message Queuing Protocol**) é um protocolo aberto e padronizado para comunicação entre sistemas por meio de mensagens, usado pelo **RabbitMQ**.
